...
The separate [`../fieldwork/synthetic/association_demo/analysis_report_synthetic.md`](../fieldwork/synthetic/association_demo/analysis_report_synthetic.md) exercises Spearman correlations, exploratory regressions, and a mixed methods joint display. Its quantitative signal and qualitative content are generated by code. It is a software demonstration, not an extension of the public benchmark or a fieldwork result.
