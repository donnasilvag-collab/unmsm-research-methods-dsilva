...
- **Synthetic association demonstration:** 64 generated survey records in eight fictional organizations, plus fictitious interview and document patterns. This fixture tests correlations, regressions, diagnostics, and joint integration. Its designed signal and outputs are not participant evidence.
...
| Synthetic association demonstration | Generated scores, organization codes, narratives, document patterns, and analytical outputs. | The script requires a synthetic-data flag, records hashes, and labels every output as a software demonstration rather than a finding. |
